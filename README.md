...
Este repositório é a **versão de design melhorado** (identidade SESI, painel e login redesenhados). Existe uma
...
|---|---|---|
| **Clássica** | https://github.com/DaniloAmaralUX/SESI- | https://sesi-prototipo-v1-2.vercel.app |
| **Design melhorado** (este repo) | https://github.com/DaniloAmaralUX/SESI-SELETIVO-HANDOFF | https://app-nine-chi-65.vercel.app |
