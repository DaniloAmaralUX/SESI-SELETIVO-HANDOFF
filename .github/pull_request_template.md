...
- [ ] **Material de registry** — se ligou componente de `components/iconiq/`, seguiu as
      regras do [NOTICE](../NOTICE.md) (chamada de rede a terceiro? `process.env`? cor hard-coded?).
