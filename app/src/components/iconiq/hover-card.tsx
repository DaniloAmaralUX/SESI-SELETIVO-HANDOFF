...
const hoverCardPanelClassName = cn(
  ...
  'relative z-50 w-72 border border-[color:var(--hc-border)] bg-[color:var(--hc-surface)] p-4 text-[color:var(--hc-foreground)] shadow-2xl outline-none'
)

const hoverCardTriggerClassName = cn(
  controlCornerClassName,
  'inline-flex min-h-9 cursor-pointer items-center px-1.5 focus-visible:ring-2 focus-visible:ring-[color:color-mix(in_oklch,var(--hc-ring),transparent_40%)] focus-visible:ring-offset-2 focus-visible:ring-offset-[color:var(--hc-surface)] focus-visible:outline-none'
)
