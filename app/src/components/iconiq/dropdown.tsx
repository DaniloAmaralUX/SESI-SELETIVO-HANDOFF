        ...
        {open ? (
          <motion.div
            ...
            className={cn(
              ...
              'absolute z-[300] max-w-[calc(100vw-1.5rem)] min-w-[12rem] overflow-hidden border border-border/60 bg-card shadow-[0_14px_34px_-22px_hsl(var(--ic-foreground)/0.28)]',
              className
            )}
...
export const DropdownItem = React.forwardRef<HTMLDivElement, DropdownItemProps>(
  (
    ...
    const sharedProps = {
      ...
      className: cn(
        controlCornerClassName,
        'group relative isolate flex min-h-11 w-full scroll-m-1 items-center justify-between gap-3 px-3 py-2.5 text-left text-sm text-foreground transition-colors',
...
>(({ className, ...props }, ref) => (
  <div
    className={cn(
      'px-3 pt-1 pb-1 text-[0.68rem] font-medium tracking-[0.12em] text-muted-foreground/80 uppercase',
      className
    )}
    ref={ref}
    {...props}
