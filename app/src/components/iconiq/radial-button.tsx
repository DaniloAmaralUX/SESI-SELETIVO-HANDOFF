    ...
    return (
      <motion.button
        ...
        className={cn(
          ...
          'relative inline-flex h-12 cursor-pointer touch-manipulation items-center justify-center overflow-hidden px-8 text-[15px] font-medium tracking-[-0.02em] select-none',
