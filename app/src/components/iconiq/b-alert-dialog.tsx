...
const alertDialogTriggerClassName = cn(
  ...
  'inline-flex min-h-11 items-center justify-center bg-[color:var(--adlg-action-surface)] px-4 py-2.5 text-[14px] font-medium tracking-[-0.01em] text-[color:var(--adlg-action-foreground)] transition-[transform,background-color] duration-200 ease-[cubic-bezier(0.16,1,0.3,1)] hover:-translate-y-px hover:bg-[color:color-mix(in_oklch,var(--adlg-action-surface),transparent_10%)] focus-visible:ring-2 focus-visible:ring-[color:color-mix(in_oklch,var(--adlg-ring),transparent_50%)] focus-visible:ring-offset-2 focus-visible:ring-offset-[color:var(--adlg-surface)] focus-visible:outline-none active:translate-y-0 active:bg-[color:color-mix(in_oklch,var(--adlg-action-surface),transparent_20%)] disabled:pointer-events-none disabled:opacity-50'
)

const alertDialogTriggerSmClassName = cn(
  controlCornerClassName,
  'inline-flex h-8 min-h-8 translate-y-px items-center bg-[color:var(--adlg-action-surface)] px-3 py-0 text-[13px] font-medium tracking-[-0.01em] text-[color:var(--adlg-action-foreground)] transition-[transform,background-color] duration-200 ease-[cubic-bezier(0.16,1,0.3,1)] hover:-translate-y-px hover:bg-[color:color-mix(in_oklch,var(--adlg-action-surface),transparent_10%)] focus-visible:ring-2 focus-visible:ring-[color:color-mix(in_oklch,var(--adlg-ring),transparent_50%)] focus-visible:ring-offset-2 focus-visible:ring-offset-[color:var(--adlg-surface)] focus-visible:outline-none active:translate-y-0 active:bg-[color:color-mix(in_oklch,var(--adlg-action-surface),transparent_20%)] disabled:pointer-events-none disabled:opacity-50'
)

const alertDialogActionClassName = cn(
  controlCornerClassName,
  'inline-flex min-h-11 items-center justify-center bg-[color:var(--adlg-destructive)] px-4 py-2.5 text-[14px] font-medium tracking-[-0.01em] text-[color:var(--adlg-destructive-foreground)] transition-[transform,filter] duration-200 ease-[cubic-bezier(0.16,1,0.3,1)] hover:-translate-y-px hover:brightness-95 focus-visible:ring-2 focus-visible:ring-[color:color-mix(in_oklch,var(--adlg-destructive),transparent_30%)] focus-visible:ring-offset-2 focus-visible:outline-none active:translate-y-0 active:brightness-90 disabled:pointer-events-none disabled:opacity-50'
)

const alertDialogDefaultActionClassName = cn(
  controlCornerClassName,
  'inline-flex min-h-11 items-center justify-center bg-[color:var(--adlg-action-surface)] px-4 py-2.5 text-[14px] font-medium tracking-[-0.01em] text-[color:var(--adlg-action-foreground)] transition-[transform,background-color] duration-200 ease-[cubic-bezier(0.16,1,0.3,1)] hover:-translate-y-px hover:bg-[color:color-mix(in_oklch,var(--adlg-action-surface),transparent_10%)] focus-visible:ring-2 focus-visible:ring-[color:color-mix(in_oklch,var(--adlg-ring),transparent_50%)] focus-visible:ring-offset-2 focus-visible:outline-none active:translate-y-0 active:bg-[color:color-mix(in_oklch,var(--adlg-action-surface),transparent_20%)] disabled:pointer-events-none disabled:opacity-50'
)

const alertDialogCancelClassName = cn(
  controlCornerClassName,
  'inline-flex min-h-11 items-center justify-center bg-[color:color-mix(in_oklch,var(--adlg-muted),transparent_45%)] px-4 py-2.5 text-[14px] font-medium tracking-[-0.01em] text-[color:var(--adlg-muted-foreground)] transition-colors duration-150 hover:bg-accent/60 hover:text-[color:var(--adlg-foreground)] focus-visible:ring-2 focus-visible:ring-[color:color-mix(in_oklch,var(--adlg-ring),transparent_50%)] focus-visible:ring-offset-2 focus-visible:ring-offset-[color:var(--adlg-surface)] focus-visible:outline-none disabled:pointer-events-none disabled:opacity-50'
)
...
>(({ children, className, open: openProp, ...props }, ref) => {
  ...
  const contentVariantConfig = reduceMotion
    ...
    : contentVariants
  const childVariantConfig = reduceMotion ? reducedChildVariants : childVariants
...
>(({ className, ...props }, ref) => {
  return (
    <AlertDialogPrimitive.Title
      className={cn(
        'text-[1.35rem] leading-tight font-semibold tracking-[-0.03em] text-[color:var(--adlg-foreground)]',
        className
      )}
      ref={ref}
      {...props}
...
>(({ className, ...props }, ref) => {
  return (
    <AlertDialogPrimitive.Description
      className={cn(
        'max-w-[46ch] text-[15px] leading-6 text-[color:var(--adlg-muted-foreground)]',
        className
      )}
      ref={ref}
      {...props}
