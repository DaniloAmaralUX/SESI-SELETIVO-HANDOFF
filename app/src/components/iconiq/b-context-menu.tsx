...
const contextMenuItemClassName = cn(
  controlCornerClassName,
  'group/context-menu-item relative flex w-full cursor-pointer items-center gap-2.5 px-3 py-2.5 text-left text-sm font-medium transition-colors outline-none'
)
...
const contextMenuIndicatorItemClassName = cn(
  controlCornerClassName,
  'group/context-menu-item relative flex w-full cursor-pointer items-center gap-2.5 py-2.5 pr-8 pl-3 text-left text-sm font-medium transition-colors outline-none'
)

const contextMenuItemDefaultClassName =
  'text-[color:color-mix(in_oklch,var(--cm-foreground),transparent_15%)]'

const contextMenuItemDestructiveClassName = 'text-[color:var(--cm-destructive)]'
...
function ContextMenuLabel({
  ...
  return (
    <ContextMenuPrimitive.GroupLabel
      className={cn(
        'px-3 py-1 text-xs font-medium text-[color:var(--cm-muted-foreground)]',
        inset && 'pl-7',
        className
      )}
      data-inset={inset ? '' : undefined}
