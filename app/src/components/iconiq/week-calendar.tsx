    ...
    return (
      <div
        className={cn(
          ...
          'w-full max-w-[21rem] rounded-2xl border border-[var(--ic-border)] bg-[var(--ic-card)] px-4 pt-4 pb-2 font-sans text-[var(--ic-card-foreground)] ring-1 ring-black/[0.03] select-none dark:ring-white/[0.06]',
      ...
      >
              ...
              {isViewingCurrentPeriod ? null : (
                <motion.button
                  ...
                  className={cn(
                    ...
                    'shrink-0 cursor-pointer rounded-full bg-[var(--ic-accent)] px-2.5 py-1 text-[11px] font-semibold text-[var(--ic-card-foreground)] transition-colors duration-150 hover:bg-[var(--ic-border)]'
                  )}
        ...
        <div className='grid grid-cols-7 px-0.5 pb-1'>
          {weekdayLabels.map((label, index) => (
            <span
              className='text-center text-[10px] font-semibold tracking-wide text-[var(--ic-muted-foreground)] uppercase'
              key={`${label}-${index}`}
            >
              {label}
            </span>
        ...
        <div className='flex justify-center pt-1.5 pb-0.5'>
          <motion.button
            ...
            className={cn(
              focusVisibleClassName,
              'h-[5px] w-9 cursor-grab touch-none rounded-full bg-[var(--ic-border)] transition-colors duration-150 outline-none hover:bg-[var(--ic-muted-foreground)]/40 active:cursor-grabbing'
            )}
            drag='y'
