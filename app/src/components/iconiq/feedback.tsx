  ...
  return (
    ...
    >
      <span className='flex items-center gap-1.5' ref={contentRef}>
        ...
        />
        <span className='text-xs leading-none font-semibold whitespace-nowrap text-foreground'>
          {label}
        </span>
        <span aria-hidden='true' className='h-3 w-px shrink-0 bg-border' />
        <motion.span
          className='shrink-0 text-xs leading-none font-medium text-muted-foreground'
  ...
  return (
    ...
    >
      <div className='flex items-center gap-2'>
        ...
        />
        <motion.span
          className='leading-none font-medium text-foreground'
          layoutId={labelLayoutId}
          transition={labelTransition}
        >
          Feedback
      ...
      <motion.textarea
        ...
        className='w-full flex-1 resize-none bg-transparent leading-relaxed text-foreground outline-none placeholder:text-muted-foreground disabled:opacity-60'
        disabled={submitting}
        initial={reduceMotion ? false : { opacity: 0 }}
      ...
      >
        ...
        <button
          ...
          className='flex items-center gap-1.5 rounded-full bg-foreground px-3 py-1.5 text-xs font-medium text-background transition-opacity disabled:opacity-50'
