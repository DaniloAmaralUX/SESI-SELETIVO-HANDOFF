...
function getRadioRowClassName({
  ...
  return cn(
    'relative flex touch-manipulation items-center gap-3.5 rounded-lg py-3.5 text-left outline-none select-none focus-visible:ring-2',
...
function RadioGroupLegend({
  ...
  return (
    <legend
      className={cn(
        '[margin-inline:0] mb-0 block w-full max-w-full [padding-inline:0] px-0 pt-0 text-sm font-medium text-foreground',
        labelClassName
      )}
      id={groupLabelId}
    >
