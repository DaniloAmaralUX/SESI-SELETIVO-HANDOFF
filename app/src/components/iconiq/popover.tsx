...
const popoverPanelClassName = cn(
  ...
  'z-50 w-72 transform-gpu border border-[color:var(--po-border)] bg-[color:var(--po-surface)] p-4 text-[color:var(--po-foreground)] shadow-lg will-change-[transform,opacity,filter] outline-none'
)

const popoverTriggerClassName = cn(
  controlCornerClassName,
  'inline-flex min-h-11 min-w-11 touch-manipulation items-center justify-center focus-visible:ring-2 focus-visible:ring-[color:color-mix(in_oklch,var(--po-ring),transparent_50%)] focus-visible:ring-offset-2 focus-visible:ring-offset-[color:var(--po-surface)] focus-visible:outline-none'
)
