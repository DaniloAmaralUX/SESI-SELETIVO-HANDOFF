  ...
  return (
    ...
    >
      <div className='space-y-1'>
        {label ? (
          <span
            className='text-[12px] font-medium tracking-[-0.02em] text-foreground/90 sm:text-[13px]'
            id={labelId}
          >
            {label}
          </span>
        ...
        {helper ? (
          <p
            className='max-w-xl text-[12px] leading-5 text-muted-foreground sm:text-[13px]'
            id={helperId}
          >
            {helper}
          </p>
      ...
      {showValue ? (
        <motion.span
          ...
          className='shrink-0 text-[12px] font-medium tracking-[-0.02em] text-muted-foreground tabular-nums sm:text-[13px]'
