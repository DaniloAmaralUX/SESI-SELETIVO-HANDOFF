...
function Kbd({ className, ...props }: React.ComponentProps<'kbd'>) {
  return (
    <kbd
      className={cn(
        'pointer-events-none inline-flex h-5 w-fit min-w-5 items-center justify-center gap-1 rounded-[6px] border border-border bg-background px-1.5 font-sans text-[11px] font-medium text-muted-foreground select-none',
        className
      )}
      data-slot='kbd'
      {...props}
...
function CommandMenuTrigger({
  ...
  return (
    <button
      className={cn(
        'flex w-full max-w-sm items-center gap-2 rounded-lg border border-border/80 bg-background/60 px-3 py-2 text-left text-sm text-muted-foreground backdrop-blur-sm transition-colors hover:bg-accent/50',
        className
      )}
  ...
  const renderItem = (item: CommandMenuItemDef, index: number, key: string) => {
    ...
    return (
      <button
        ...
        className={cn(
          'relative isolate flex w-full items-start gap-3 rounded-lg px-3 py-2.5 text-left text-sm text-foreground transition-colors focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 focus-visible:ring-offset-background focus-visible:outline-none',
      ...
      >
        ...
        <div className='relative z-10 min-w-0 flex-1'>
          <div className='flex items-center gap-2'>
            ...
            {isCurrentPage ? (
              <span className='shrink-0 rounded-full bg-accent px-2 py-0.5 text-[10px] font-medium tracking-[0.12em] text-muted-foreground uppercase'>
                Current
              </span>
            ) : null}
          </div>
          ...
          >
            ...
            <div className='flex shrink-0 items-center gap-3 border-b border-border/70 px-4 py-3'>
              ...
              <input
                ...
                autoCapitalize='off'
                autoCorrect='off'
                className='w-full min-w-0 touch-manipulation bg-transparent text-[16px] leading-normal text-foreground outline-none placeholder:text-muted-foreground md:text-sm'
              ...
              <DialogPrimitive.Close asChild>
                <button
                  ...
                  className='inline-flex size-8 shrink-0 items-center justify-center rounded-md text-muted-foreground transition-colors hover:bg-accent hover:text-foreground focus-visible:ring-2 focus-visible:ring-ring focus-visible:outline-none'
                  type='button'
                >
                  <X className='size-4' />
                </button>
                  ...
                  indexedSections.map((section, sectionIndex) => (
                    <React.Fragment key={section.heading}>
                      ...
                      <div className='px-2 py-1'>
                        <div className='px-1 pb-1.5 text-[11px] font-medium tracking-[0.16em] text-muted-foreground uppercase'>
                          {section.heading}
                        </div>
            ...
            {showFooterHints ? (
              <div
                className='flex shrink-0 flex-wrap items-center gap-x-3 gap-y-1 border-t border-border/70 px-4 py-2 text-[11px] text-muted-foreground'
