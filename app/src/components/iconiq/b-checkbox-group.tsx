          ...
          return (
            <motion.button
              ...
              className={cn(
                ...
                'focus-visible:ring-2 focus-visible:ring-primary/30 focus-visible:ring-offset-2 focus-visible:ring-offset-background focus-visible:outline-none',
      ...
      >
          ...
          if (section.label) {
            return (
              <fieldset
                ...
                key={section.key}
              >
                <legend className='px-4 pt-2 text-[11px] font-medium tracking-[0.16em] text-muted-foreground/80 uppercase'>
                  {section.label}
                </legend>
                {sectionBody}
              </fieldset>
        ...
        {disclosure.shouldShowMore ? (
          <button
            aria-expanded={false}
            className={cn(
              'self-start rounded-md px-4 py-2 text-sm font-medium text-muted-foreground transition-colors hover:text-foreground',
              'focus-visible:ring-2 focus-visible:ring-primary/30 focus-visible:ring-offset-2 focus-visible:ring-offset-background focus-visible:outline-none'
            )}
