...
export interface AccordionProps extends AccordionRootPropsBase {
...
export interface AccordionItemProps extends Omit<
  RadixAccordionItemPrimitiveProps,
  'className'
> {
  className?: string
}
...
export interface AccordionTriggerProps extends Omit<
  RadixAccordionTriggerPrimitiveProps,
  'className'
> {
  className?: string
}
...
export interface AccordionContentProps extends Omit<
  RadixAccordionContentPrimitiveProps,
  'className' | 'forceMount'
> {
  className?: string
    ...
    return (
      <div className='overflow-hidden'>
        <div className={wrapClassName}>
          <div className={copyClassName} ref={contentRef}>
            {children}
          </div>
        </div>
      </div>
...
function AccordionTriggerLabel({ children }: { children: React.ReactNode }) {
  return (
    <span className='pr-4 text-[15px] leading-6 font-medium tracking-[-0.02em] text-foreground sm:text-base'>
      {children}
    </span>
  )
}
    ...
    return (
      <AccordionPrimitive.Header className='flex'>
        ...
        >
          ...
          <span className='text-[15px] leading-6 font-normal tracking-[-0.02em] text-foreground sm:text-base'>
            {children}
          </span>
        </AccordionPrimitive.Trigger>
...
>(({ children, className, forceMount, keepMounted, ...props }, ref) => {
  ...
  return (
    <AccordionPrimitive.Content
      ...
      forceMount={shouldKeepMounted ? true : undefined}
      ref={ref}
      {...props}
    >
      <AccordionPanelBody
