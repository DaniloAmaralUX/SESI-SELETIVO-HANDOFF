      ...
      render={(rootProps) => {
        ...
        return (
          <motion.button
            ...
            className={cn(
              'relative mt-0.5 flex shrink-0 items-center justify-center rounded border focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 focus-visible:outline-none disabled:cursor-not-allowed',
              sizing.box,
              rootClassName
            )}
            initial={false}
