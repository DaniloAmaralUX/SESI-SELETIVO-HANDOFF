...
const buttonVariants = cva(
  cn(
    ...
    "group/button relative isolate inline-flex shrink-0 cursor-pointer touch-manipulation items-center justify-center overflow-hidden border border-transparent bg-clip-border text-sm font-medium whitespace-nowrap no-underline transition-[background-color,border-color,color,box-shadow] outline-none select-none focus-visible:border-[color:var(--button-ring)] focus-visible:ring-3 focus-visible:ring-[color:color-mix(in_oklch,var(--button-ring),transparent_50%)] active:not-aria-[haspopup]:translate-y-px disabled:pointer-events-none disabled:opacity-50 aria-invalid:border-[color:var(--button-destructive)] aria-invalid:ring-3 aria-invalid:ring-[color:color-mix(in_oklch,var(--button-destructive),transparent_80%)] dark:aria-invalid:border-[color:color-mix(in_oklch,var(--button-destructive),transparent_50%)] dark:aria-invalid:ring-[color:color-mix(in_oklch,var(--button-destructive),transparent_60%)] [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4"
  ),
  {
    variants: {
      variant: {
...
const LinkUnderlineLabel = memo(function LinkUnderlineLabel({
  ...
  return (
    <span className='relative inline-block pb-px text-[1em] leading-[inherit] font-medium'>
...
const ButtonLoadingLabel = memo(function ButtonLoadingLabel({
  ...
  return (
    <motion.span
      className='relative inline-grid min-w-0 [grid-template-columns:max-content] [grid-template-rows:minmax(0,1.25em)] items-center leading-[inherit]'
      layout='position'
      transition={layoutTransition}
    >
