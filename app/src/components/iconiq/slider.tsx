      ...
      {marks.map((mark) => {
        ...
        const content = (
          <>
            ...
            {mark.label ? (
              <span className='mt-1 block text-[11px] font-medium whitespace-nowrap text-muted-foreground'>
                {mark.label}
              </span>
            ) : null}
          </>
        ...
        if (interactive) {
          return (
            <button
              className='absolute top-0 -translate-x-1/2 text-center outline-none focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-foreground/35'
    ...
    >
      ...
      >
        <div
          ...
          className={cn(
            'relative flex w-full cursor-pointer items-center rounded-full outline-none focus-visible:outline-2 focus-visible:outline-offset-4 focus-visible:outline-foreground/35',
