...
const datePickerInputShellClassName = cn(
  'group flex w-full items-center border border-border bg-card text-left text-sm text-foreground transition-[border-color,box-shadow] focus-within:border-foreground/30 hover:border-foreground/30',
