...
const contextMenuItemClassName = cn(
  controlCornerClassName,
  'relative flex w-full cursor-pointer items-center gap-2.5 px-3 py-2.5 text-left text-sm font-medium transition-colors outline-none'
)
...
function MenuItem({
  ...
  return (
    ...
    >
      ...
      {item.shortcut && (
        <span className='relative z-10 text-xs tracking-widest text-[color:color-mix(in_oklch,var(--cm-muted-foreground),transparent_30%)]'>
          {item.shortcut}
        </span>
      )}
    </motion.button>
