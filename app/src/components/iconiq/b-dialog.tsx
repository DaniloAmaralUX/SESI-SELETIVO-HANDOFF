...
const dialogCloseClassName = cn(
  ...
  'absolute top-4 right-4 z-10 grid size-9 shrink-0 place-items-center text-[color:var(--dlg-muted-foreground)] transition-colors hover:bg-accent/60 hover:text-[color:var(--dlg-foreground)] focus-visible:ring-2 focus-visible:ring-[color:color-mix(in_oklch,var(--dlg-ring),transparent_50%)] focus-visible:ring-offset-2 focus-visible:ring-offset-[color:var(--dlg-surface)] focus-visible:outline-none active:bg-accent/80 [&_svg]:block [&_svg]:size-4 [&_svg]:shrink-0'
)

const dialogTriggerClassName = cn(
  controlCornerClassName,
  'inline-flex min-h-11 items-center justify-center bg-[color:var(--dlg-foreground)] px-4 py-2.5 text-[14px] font-medium tracking-[-0.01em] text-[color:var(--dlg-surface)] transition-[transform,background-color] duration-200 ease-[cubic-bezier(0.16,1,0.3,1)] hover:-translate-y-px hover:bg-[color:color-mix(in_oklch,var(--dlg-foreground),transparent_10%)] focus-visible:ring-2 focus-visible:ring-[color:color-mix(in_oklch,var(--dlg-ring),transparent_50%)] focus-visible:ring-offset-2 focus-visible:ring-offset-[color:var(--dlg-surface)] focus-visible:outline-none active:translate-y-0 active:bg-[color:color-mix(in_oklch,var(--dlg-foreground),transparent_20%)] disabled:pointer-events-none disabled:opacity-50'
)

const dialogTriggerSmClassName = cn(
  controlCornerClassName,
  'inline-flex h-8 min-h-8 translate-y-px items-center bg-[color:var(--dlg-foreground)] px-3 py-0 text-[13px] font-medium tracking-[-0.01em] text-[color:var(--dlg-surface)] transition-[transform,background-color] duration-200 ease-[cubic-bezier(0.16,1,0.3,1)] hover:-translate-y-px hover:bg-[color:color-mix(in_oklch,var(--dlg-foreground),transparent_10%)] focus-visible:ring-2 focus-visible:ring-[color:color-mix(in_oklch,var(--dlg-ring),transparent_50%)] focus-visible:ring-offset-2 focus-visible:ring-offset-[color:var(--dlg-surface)] focus-visible:outline-none active:translate-y-0 active:bg-[color:color-mix(in_oklch,var(--dlg-foreground),transparent_20%)] disabled:pointer-events-none disabled:opacity-50'
)

const dialogCancelClassName = cn(
  controlCornerClassName,
  'inline-flex min-h-11 items-center justify-center bg-[color:color-mix(in_oklch,var(--dlg-muted),transparent_45%)] px-4 py-2.5 text-[14px] font-medium tracking-[-0.01em] text-[color:var(--dlg-muted-foreground)] transition-colors duration-150 hover:bg-accent/60 hover:text-[color:var(--dlg-foreground)] focus-visible:ring-2 focus-visible:ring-[color:color-mix(in_oklch,var(--dlg-ring),transparent_50%)] focus-visible:ring-offset-2 focus-visible:ring-offset-[color:var(--dlg-surface)] focus-visible:outline-none active:bg-accent/80 disabled:pointer-events-none disabled:opacity-50'
)
...
const dialogDestructiveActionClassName = cn(
  controlCornerClassName,
  'inline-flex min-h-11 items-center justify-center bg-[color:var(--dlg-destructive)] px-4 py-2.5 text-[14px] font-medium tracking-[-0.01em] text-[color:var(--dlg-destructive-foreground)] transition-[transform,filter] duration-200 ease-[cubic-bezier(0.16,1,0.3,1)] hover:-translate-y-px hover:brightness-95 focus-visible:ring-2 focus-visible:ring-[color:color-mix(in_oklch,var(--dlg-destructive),transparent_30%)] focus-visible:ring-offset-2 focus-visible:outline-none active:translate-y-0 active:brightness-90 disabled:pointer-events-none disabled:opacity-50'
)
...
>(({ className, ...props }, ref) => {
  return (
    <DialogPrimitive.Title
      className={cn(
        'text-[1.35rem] leading-tight font-semibold tracking-[-0.03em] text-[color:var(--dlg-foreground)]',
        className
      )}
      ref={ref}
      {...props}
...
>(({ className, ...props }, ref) => {
  return (
    <DialogPrimitive.Description
      className={cn(
        'max-w-[46ch] text-[15px] leading-6 text-[color:var(--dlg-muted-foreground)]',
        className
      )}
      ref={ref}
      {...props}
