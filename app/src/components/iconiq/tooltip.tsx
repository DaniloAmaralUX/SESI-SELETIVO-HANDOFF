...
const tooltipContentClassName = cn(
  ...
  'group/tooltip pointer-events-none relative z-50 max-w-60 bg-[color:var(--tt-surface)] px-3 py-1.5 text-xs leading-snug font-medium whitespace-normal text-[color:var(--tt-foreground)] shadow-[0_4px_24px_-4px_rgba(0,0,0,0.25)]'
)
