...
const menuItemClassName = cn(
  menuCornerClassName,
  'relative isolate flex min-h-11 w-full cursor-pointer touch-manipulation items-center gap-2 px-3 py-2.5 text-left text-sm text-foreground transition-colors outline-none select-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-inset'
)
...
function buildBreadcrumbTrailNodes({
  ...
  const pushSeparator = (key: string) => {
    nodes.push(<BreadcrumbSeparator key={key}>{separator}</BreadcrumbSeparator>)
  }
