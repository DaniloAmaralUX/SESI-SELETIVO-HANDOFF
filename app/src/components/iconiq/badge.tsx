...
interface BadgeProps
  extends
    Omit<SpanHTMLAttributesForMotion, 'color'>,
...
function BadgeDismissButton({
  ...
  return (
    <button
      ...
      className={cn(
        'relative z-20 inline-flex shrink-0 items-center justify-center rounded-full text-current/70 transition-colors hover:bg-[color-mix(in_srgb,currentColor_12%,transparent)] hover:text-current focus-visible:ring-1 focus-visible:ring-ring focus-visible:outline-none',
