    ...
    >
      ...
      >
        ...
        <button
          ...
          className={cn(
            'pointer-events-auto absolute top-3 right-3 flex h-7 w-7 items-center justify-center text-white/80 opacity-0 transition-[opacity,color,transform] duration-150 ease-out group-hover:opacity-100 hover:text-white active:scale-90 sm:top-4 sm:right-4',
        ...
        <div className='pointer-events-none absolute inset-x-3 bottom-3 flex min-w-0 flex-col gap-1.5 sm:inset-x-4 sm:bottom-4'>
          {isSelected ? (
            <input
              className='pointer-events-auto w-full truncate rounded-md bg-transparent text-[15px] leading-tight font-semibold tracking-[-0.01em] text-white outline-none placeholder:text-white/50 focus-visible:ring-1 focus-visible:ring-white/60'
              data-no-drag='true'
            ...
            <div className='truncate text-[15px] leading-tight font-semibold tracking-[-0.01em]'>
              {tile.label}
            </div>
          )}
          <div className='inline-flex w-fit items-center rounded-full bg-black/15 px-2 py-0.5 text-[10px] font-medium tracking-wider text-white/70 tabular-nums'>
            {tile.w} × {tile.h}
          </div>
        </div>
        ...
        <div
          className={cn(
            'absolute right-2 bottom-2 flex h-6 w-6 cursor-nwse-resize items-center justify-center text-white/85 opacity-0 transition-[opacity,color] duration-150 ease-out group-hover:opacity-100 hover:text-white',
            isSelected && 'opacity-100'
          )}
          data-resize='true'
