  ...
  return (
    ...
    >
      <AccordionPrimitive.Header className='flex'>
        ...
        >
          <span className='text-[15px] leading-6 font-medium tracking-[-0.02em] text-foreground'>
          ...
          <div className='relative' data-slot='faq-pro-search'>
            ...
            {query ? (
              <button
                ...
                className='absolute top-1/2 right-3 inline-flex size-7 -translate-y-1/2 items-center justify-center rounded-full text-muted-foreground transition-colors hover:bg-accent/60 hover:text-foreground focus-visible:ring-2 focus-visible:ring-ring focus-visible:outline-none'
                onClick={() => {
                  updateQuery('')
