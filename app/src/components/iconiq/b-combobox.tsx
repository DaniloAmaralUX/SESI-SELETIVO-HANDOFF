      ...
      render={(clearProps, clearState) => {
        ...
        return (
          <button
            ...
            className={cn(
              'flex size-8 shrink-0 items-center justify-center overflow-hidden rounded-md text-muted-foreground/70 transition-colors hover:bg-accent/60 hover:text-foreground focus-visible:ring-2 focus-visible:ring-ring/30 focus-visible:outline-none disabled:cursor-not-allowed disabled:opacity-50',
...
function ComboboxTrigger({
  ...
  return (
    <ComboboxPrimitive.Trigger
      ...
      className={cn(
        'flex size-8 shrink-0 items-center justify-center text-muted-foreground transition-colors hover:bg-accent/40 focus-visible:ring-2 focus-visible:ring-ring/30 focus-visible:outline-none disabled:cursor-not-allowed disabled:opacity-50',
...
function ComboboxItemPanel({
  ...
  return (
    <motion.div
      ...
      className={cn(
        'relative flex cursor-pointer items-start gap-2 px-2.5 py-2 text-sm text-foreground transition-colors select-none',
        controlCornerClassName,
        itemState.disabled &&
    ...
    >
      ...
      <span className='relative z-10 flex flex-col'>
        <span className='leading-tight font-medium'>{children}</span>
        {description ? (
...
function ComboboxChip({
  ...
  return (
    <ComboboxPrimitive.Chip
      className={cn(
        'flex h-[calc(var(--spacing)*5.25)] w-fit items-center justify-center gap-1 bg-muted px-1.5 text-xs font-medium whitespace-nowrap text-foreground has-disabled:pointer-events-none has-disabled:cursor-not-allowed has-disabled:opacity-50 has-data-[slot=combobox-chip-remove]:pr-0',
    ...
    >
      ...
      {showRemove ? (
        <ComboboxPrimitive.ChipRemove
          ...
          className={cn(
            '-ml-1 flex size-5 items-center justify-center opacity-50 transition-colors hover:bg-accent/60 hover:opacity-100 focus-visible:ring-2 focus-visible:ring-ring/30 focus-visible:outline-none',
            controlCornerXsClassName
          )}
