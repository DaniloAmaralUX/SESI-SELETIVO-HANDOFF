...
const toggleGroupItemVariants = cva(
  cn(
    ...
    "relative inline-flex shrink-0 cursor-pointer items-center justify-center gap-1 overflow-hidden text-sm font-medium whitespace-nowrap transition-colors outline-none focus-visible:border-ring focus-visible:ring-[3px] focus-visible:ring-ring/50 disabled:pointer-events-none disabled:opacity-50 aria-invalid:border-destructive aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4"
  ),
  {
    variants: {
      variant: {
        default: cn('bg-transparent', togglePressedTextRadix),
        outline: cn(
          'border border-input bg-transparent',
          togglePressedTextRadix
        ),
      },
      size: {
        default:
