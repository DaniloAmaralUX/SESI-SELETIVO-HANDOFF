...
function WheelPickerItem({
  ...
  return (
    ...
    >
      <motion.span
        className={cn(
          'absolute inset-0 flex items-center justify-center truncate px-1 text-[17px] leading-none font-medium tabular-nums',
...
export function WheelPickerColumn({
  ...
  return (
    <div
      ...
      className={cn(
        'relative min-w-0 flex-1 cursor-pointer touch-none overflow-hidden outline-none select-none [-webkit-tap-highlight-color:transparent] focus-visible:ring-2 focus-visible:ring-ring/60 active:cursor-grabbing',
