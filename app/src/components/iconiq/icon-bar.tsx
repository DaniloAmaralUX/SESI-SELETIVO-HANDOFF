...
function IconBarItemButton({
  ...
  return (
    ...
    >
      ...
      >
        <span className='block pr-3 text-[14px] font-medium tracking-[-0.01em] whitespace-nowrap'>
          {label}
        </span>
      </motion.div>
      ...
      <span
        aria-hidden
        className='pointer-events-none absolute top-0 pr-3 text-[14px] font-medium tracking-[-0.01em] whitespace-nowrap opacity-0'
        ref={measureRef}
