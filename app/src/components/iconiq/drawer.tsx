...
const drawerCloseClassName = cn(
  ...
  'absolute top-4 right-4 z-10 grid size-9 shrink-0 place-items-center text-[color:var(--drw-muted-foreground)] transition-colors hover:bg-accent/60 hover:text-[color:var(--drw-foreground)] focus-visible:ring-2 focus-visible:ring-[color:color-mix(in_oklch,var(--drw-ring),transparent_50%)] focus-visible:ring-offset-2 focus-visible:ring-offset-[color:var(--drw-surface)] focus-visible:outline-none active:bg-accent/80 [&_svg]:block [&_svg]:size-4 [&_svg]:shrink-0'
)

const drawerTriggerClassName = cn(
  controlCornerClassName,
  'inline-flex min-h-11 items-center justify-center bg-[color:var(--drw-foreground)] px-4 py-2.5 text-[14px] font-medium tracking-[-0.01em] text-[color:var(--drw-surface)] transition-[transform,background-color] duration-200 ease-[cubic-bezier(0.16,1,0.3,1)] hover:-translate-y-px hover:bg-[color:color-mix(in_oklch,var(--drw-foreground),transparent_10%)] focus-visible:ring-2 focus-visible:ring-[color:color-mix(in_oklch,var(--drw-ring),transparent_50%)] focus-visible:ring-offset-2 focus-visible:ring-offset-[color:var(--drw-surface)] focus-visible:outline-none active:translate-y-0 active:bg-[color:color-mix(in_oklch,var(--drw-foreground),transparent_20%)] disabled:pointer-events-none disabled:opacity-50'
)

const drawerTriggerSmClassName = cn(
  controlCornerClassName,
  'inline-flex h-8 min-h-8 translate-y-px items-center bg-[color:var(--drw-foreground)] px-3 py-0 text-[13px] font-medium tracking-[-0.01em] text-[color:var(--drw-surface)] transition-[transform,background-color] duration-200 ease-[cubic-bezier(0.16,1,0.3,1)] hover:-translate-y-px hover:bg-[color:color-mix(in_oklch,var(--drw-foreground),transparent_10%)] focus-visible:ring-2 focus-visible:ring-[color:color-mix(in_oklch,var(--drw-ring),transparent_50%)] focus-visible:ring-offset-2 focus-visible:ring-offset-[color:var(--drw-surface)] focus-visible:outline-none active:translate-y-0 active:bg-[color:color-mix(in_oklch,var(--drw-foreground),transparent_20%)] disabled:pointer-events-none disabled:opacity-50'
)

const drawerCancelClassName = cn(
  controlCornerClassName,
  'inline-flex min-h-11 items-center justify-center bg-[color:color-mix(in_oklch,var(--drw-muted),transparent_45%)] px-4 py-2.5 text-[14px] font-medium tracking-[-0.01em] text-[color:var(--drw-muted-foreground)] transition-colors duration-150 hover:bg-accent/60 hover:text-[color:var(--drw-foreground)] focus-visible:ring-2 focus-visible:ring-[color:color-mix(in_oklch,var(--drw-ring),transparent_50%)] focus-visible:ring-offset-2 focus-visible:ring-offset-[color:var(--drw-surface)] focus-visible:outline-none active:bg-accent/80 disabled:pointer-events-none disabled:opacity-50'
)
...
const drawerDestructiveActionClassName = cn(
  controlCornerClassName,
  'inline-flex min-h-11 items-center justify-center bg-[color:var(--drw-destructive)] px-4 py-2.5 text-[14px] font-medium tracking-[-0.01em] text-[color:var(--drw-destructive-foreground)] transition-[transform,filter] duration-200 ease-[cubic-bezier(0.16,1,0.3,1)] hover:-translate-y-px hover:brightness-95 focus-visible:ring-2 focus-visible:ring-[color:color-mix(in_oklch,var(--drw-destructive),transparent_30%)] focus-visible:ring-offset-2 focus-visible:outline-none active:translate-y-0 active:brightness-90 disabled:pointer-events-none disabled:opacity-50'
)
...
const drawerContentBaseClassName = cn(
  ...
  '[transition-timing-function:cubic-bezier(0.32,0.72,0,1)] [--initial-transform:calc(100%+16px)] [animation-duration:520ms] [animation-timing-function:cubic-bezier(0.32,0.72,0,1)] data-[state=closed]:[animation-duration:320ms] motion-reduce:animate-none motion-reduce:transition-none'
)
...
type DrawerNestedProps = React.ComponentProps<typeof DrawerPrimitive.NestedRoot>
...
>(({ className, ...props }, ref) => (
  <DrawerPrimitive.Overlay
    className={cn(
      'fixed inset-0 z-50 bg-black/45 data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:animate-in data-[state=open]:fade-in-0 supports-backdrop-filter:backdrop-blur-sm motion-reduce:animate-none dark:bg-black/55',
...
>(({ className, ...props }, ref) => (
  <div
    className={cn(
      'mt-auto flex shrink-0 flex-col-reverse gap-2 border-t border-[color:color-mix(in_oklch,var(--drw-border),transparent_25%)] p-4 sm:flex-row sm:justify-end',
      className
    )}
...
>(({ className, ...props }, ref) => (
  <DrawerPrimitive.Title
    className={cn(
      'text-[1.15rem] leading-tight font-semibold tracking-[-0.03em] text-[color:var(--drw-foreground)]',
      className
    )}
...
>(({ className, ...props }, ref) => (
  <DrawerPrimitive.Description
    className={cn(
      'mx-auto max-w-[46ch] text-[14px] leading-6 text-[color:var(--drw-muted-foreground)] group-data-[vaul-drawer-direction=bottom]/drawer-content:text-center group-data-[vaul-drawer-direction=top]/drawer-content:text-center md:group-data-[vaul-drawer-direction=bottom]/drawer-content:mx-0 md:group-data-[vaul-drawer-direction=bottom]/drawer-content:text-left md:group-data-[vaul-drawer-direction=top]/drawer-content:mx-0 md:group-data-[vaul-drawer-direction=top]/drawer-content:text-left',
      className
    )}
