        ...
        >
          <div className='relative'>
            <SliderPrimitive.Control
              ...
              className={cn(
                'relative flex w-full cursor-pointer items-center rounded-full outline-none focus-within:outline-2 focus-within:outline-offset-4 focus-within:outline-foreground/35',
