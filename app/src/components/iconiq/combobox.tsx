                ...
                filtered.map((opt, index) => {
                  ...
                  return (
                    <motion.div
                      ...
                      className={cn(
                        'relative flex cursor-pointer items-start gap-2 px-2.5 py-2 text-sm transition-colors select-none',
                        controlCornerClassName,
      ...
      >
        ...
        {clearable && selected && !disabled && (
          <button
            ...
            className={cn(
              'flex h-10 w-10 shrink-0 items-center justify-center text-muted-foreground opacity-70 transition-colors hover:bg-accent/60 hover:opacity-100 focus-visible:ring-2 focus-visible:ring-ring/30 focus-visible:outline-none',
              controlCornerClassName
            )}
            onClick={(e) => {
              e.stopPropagation()
