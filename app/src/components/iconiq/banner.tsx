...
function BannerSheen() {
  return (
    <motion.span
      ...
      aria-hidden
      className='pointer-events-none absolute inset-0 bg-[linear-gradient(110deg,transparent_30%,rgba(255,255,255,0.1)_50%,transparent_70%)] bg-[length:250%_100%] dark:bg-[linear-gradient(110deg,transparent_30%,rgba(255,255,255,0.22)_50%,transparent_70%)]'
...
function BannerAction({
  ...
  const sharedClass = cn(
    'shrink-0 rounded-lg border bg-transparent px-3.5 py-1.5 text-xs font-medium transition-colors duration-200 outline-none focus-visible:ring-2 focus-visible:ring-ring/60',
    actionClass
  )
...
function BannerDismiss({
  ...
  return (
    <motion.button
      ...
      className={cn(
        'flex size-7 shrink-0 items-center justify-center rounded-md transition-colors duration-200 outline-none focus-visible:ring-2 focus-visible:ring-ring/60',
        dismissClass
      )}
      onClick={onClick}
      type='button'
...
function BannerBarContent({
  ...
  return (
    <>
      ...
      <span className='min-w-0 flex-1 text-left leading-snug font-medium'>
        {children}
      </span>
