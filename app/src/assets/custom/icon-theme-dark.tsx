...
export function IconThemeDark(props: SVGProps<SVGSVGElement>) {
  return (
    <svg
      ...
      {...props}
    >
      <g fill='oklch(0.286 0.042 257.306)'>
      ...
      <path
        ...
        fill='oklch(0.202 0.039 263.185)'
      />
      <circle cx={6.7} cy={7.04} r={3.54} fill='oklch(0.485 0.072 254.086)' />
      <path
        ...
        fill='oklch(0.485 0.072 254.086)'
      />
      <g fill='oklch(0.509 0.154 259.604)'>
        <rect
          x={33.36}
          y={19.73}
          width={2.75}
